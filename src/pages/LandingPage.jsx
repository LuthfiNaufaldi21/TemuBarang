...
function LandingPage() {
  return (
    // Wrapper 1
    <div className="w-full min-h-screen bg-black text-white  overflow-x-hidden selection:bg-[#164A41] selection:text-white">
      {/*NAVBAR*/}
      <nav className="fixed top-0 left-0 w-full z-50 bg-black/90 backdrop-blur-md border-b border-[#4D774E]/20 px-6 md:px-12 py-5 flex justify-between items-center">
        <div className="text-2xl font-bold text-[#9DC88D]">
        ...
        <Link
          to="/login"
          className="bg-[#F1B24A] hover:bg-[#c28a30] text-black px-6 py-2.5 rounded-full font-semibold transition-all duration-300 hover:shadow-[0_10px_25px_rgba(0,0,0,0.5)] hover:-translate-y-0.5"
        >
          Login
        </Link>
      </nav>
      ...
      <section className="relative min-h-screen w-full flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl flex flex-col items-center opacity-0 animate-[fadeUp_0.9s_ease-out_forwards]">
          <h1 className="text-5xl md:text-[56px] font-semibold leading-[1.1] text-[#E2E3DD] tracking-tight">
            Temukan Barangmu,
            <br />
            Kembalikan<span> </span>
            <span className="text-[#F1B24A]">Senyum Mereka</span>
          </h1>
          <p className="mt-5 text-[#9DC88D] text-lg md:text-[18px] leading-7.25 max-w-162.5 mx-auto font-medium">
      ...
      <section
        id="features"
        className="py-24 px-6 md:px-12 max-w-300 mx-auto flex flex-col items-center scroll-mt-24"
      >
        <h2 className="text-[36px] font-semibold text-[#E2E3DD] mb-12">
          Features
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {/*card1*/}
          <div className="bg-[#164A41] p-8 rounded-3xl outline-1 outline-[#4D774E]/20 flex flex-col justify-between min-h-64 relative overflow-hidden group transform transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_24px_60px_rgba(0,0,0,0.7)]">
          ...
          {/*card2*/}
          <div className="bg-[#164A41] p-8 rounded-3xl outline-1 outline-[#4D774E]/20 flex flex-col justify-between min-h-64 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_24px_60px_rgba(0,0,0,0.7)]">
            <img
              src={PrivChatt}
              alt="Secure Access Icon"
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-[36px] font-semibold text-[#E2E3DD] mb-3">
            How It Works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full relative items-center">
          ...
          <div className="bg-black border border-[#4D774E]/40 rounded-3xl p-8 flex flex-col items-center text-center relative z-10 min-h-60">
          ...
          <div className="bg-black border border-[#4D774E]/30 rounded-3xl p-8 flex flex-col items-center text-center relative z-10 min-h-60">
            <div className="w-16 h-16 bg-[#164A41] rounded-full border-4 border-black flex items-center justify-center mb-6">
              <img
                src={Match}
                alt="Match Icon"
      ...
      <section
        id="about"
        className="py-24 bg-[#164A41]/20 border-y border-[#4D774E]/20 scroll-mt-24"
      >
        <div className="max-w-300 mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <h2 className="text-[36px] text-white font-semibold">
              About TemuBarang
            </h2>
      ...
      <section
        id="support"
        className="py-24 px-6 md:px-12 max-w-300 mx-auto flex flex-col items-center gap-16 scroll-mt-24"
      >
        <div className="w-full flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button className="px-8 py-3 rounded-lg border border-[#10B981] text-[#10B981] hover:bg-[#10B981]/10 transition-colors duration-300 hover:shadow-[0_12px_30px_rgba(0,0,0,0.5)]">
            Contact Support
          </button>
        </div>
